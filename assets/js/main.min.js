...
$(function () {
    ...
    function cunbt() {
        ...
        $('.count_cone').each(function (i, obj) {
            ...
            biland += parseInt($(this).find('.a_qty').val());
        });
...
if ($('#belegungsplan').length > 0) {
    ...
    $('#newoccupation').on('change', '.startdate, .enddate, .efilter, .sfilter, .mfilter ', function (event) {
        ...
        requestGet('belegungsplan/load_free_aq/' + a + '/' + b + '/' + c + '/' + d + '/' + e).done(function (response) {
            response = JSON.parse(response);
        /*    $('#newoccupation #wohnungen').empty();
            $('#newoccupation #wohnungen').html(response.optionsAQ);
            $('#newoccupation #wohnungen').selectpicker('refresh');
            $('#newoccupation #etage').empty();
            $('#newoccupation #etage').html(response.optionsET);
            $('#newoccupation #etage').val(response.etage); 
            $('#newoccupation #etage').selectpicker('refresh');
            $('#newoccupation #schlaplatze').empty();    
            $('#newoccupation #schlaplatze').html(response.optionsSC); 
            $('#newoccupation #schlaplatze').val(response.schlaplatze); 
            $('#newoccupation #schlaplatze').selectpicker('refresh');
            $('#newoccupation #mobiliert').empty();       
            $('#newoccupation #mobiliert').html(response.optionsMO);  
            $('#newoccupation #mobiliert').val(response.mobiliert); 
            $('#newoccupation #mobiliert').selectpicker('refresh');*/
