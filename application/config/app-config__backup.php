...
*
*/
define('APP_BASE_URL', 'https://markat-solution.com/');
 ...
 */
define('APP_DB_USERNAME', 'markat_solution_commarkat_solution');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '@6.mE&@_~+FsWE}r?=');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'markat_solution_commarkat_solution');
