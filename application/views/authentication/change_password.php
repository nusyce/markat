  ...
  <div class="row">
   ...
   <div class="mtop40 authentication-form">
    <h1><?php echo _l('admin_auth_reset_password_heading'); ?></h1>
       <p style="color: red">Das aktuelle Wort ist nicht stark. Setzen Sie es mit einem Passwort von mindestens zwölf Zeichen zurück, einschließlich mindestens eines Großbuchstaben, eines Kleinbuchstaben und einer Zahl.</p>
