            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo render_input('estimated_hours', get_transl_field('tsl_projects', ' geschatztestunden','Geschätzte Stunden'), isset($project) ? $project->estimated_hours : '', 'number'); ?>
                            </div>
                            <div class="col-md-6">
                                <?php
                                $selected = array();
...
<script>
    ...
    $(function () {
        ...
        $('#name').on('keyup keydown keypress change paste', function () {
            if ($(this).val() == '') {
                $('#name').prop('required', false);
                $('#projekte').prop('required', true);
            } else {
                $('#projekte').prop('required', false);
                $('#name').prop('required', true);
            }
        });

        $('#projekte').on('keyup keydown keypress change paste', function () {
            if ($(this).val() == '') {
                $('#projekte').prop('required', false);
                $('#name').prop('required', true);
            } else {
