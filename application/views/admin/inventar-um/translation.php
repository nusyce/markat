                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo render_input('strabe', get_transl_field('tsl_inventarlistes_un', 'strabe','Stra�e'),get_transl_field('tsl_inventarlistes_un', 'strabe','Stra�e'));?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <?php echo render_input('flugel', get_transl_field('tsl_inventarlistes_un', 'flugel','Fl�gel'), get_transl_field('tsl_inventarlistes_un', 'flugel','Fl�gel'));?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
