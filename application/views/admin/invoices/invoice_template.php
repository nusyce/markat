            ...
            <div class="col-md-6">
                <div class="panel_s no-shadow">
                  ...
                  ?>
                    ...
                    <div class="form-group">
                        <label for="number"><?php echo 'Projektnummer'; ?></label>
                        <div class="input-group">
                  <span class="input-group-addon">
                  <?php if (isset($invoice)) { ?>
                      <a href="#" onclick="return false;" data-toggle="popover" data-container='._transaction_form'
                  ...
                  ?>
                            ...
                            <input type="text" class="form-control" value="<?php echo $_invoice_number; ?>"
        ...
        <div class="table-responsive s_table">
            <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                ...
                <tr>
                    ...
                    <th width="25%" align="left" class="hide"><?php echo _l('invoice_table_item_description'); ?></th>
                    <?php
                ...
                <?php if (isset($invoice) || isset($add_items)) {
                    ...
                    foreach ($add_items as $item) {
                        ...
                        $table_row .= '</td>';
                        $table_row .= '<td class="text-center">' . $i . '</td>';
