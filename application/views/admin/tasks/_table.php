...
$table_data = [
   ...
   // _l(get_transl_field('tsl_tasks', 'mieter','Mieter')),
    ...
    //_l('task_assigned'),
    _l(get_transl_field('tsl_tasks', 'falligkeitsdatum',_l('task_assigned'))),
   ...
   // _l('Erledigt'),
    ...
    //_l('tasks_list_priority',get_transl_field('tsl_tasks', 'prioritat','Priorit�t'))
    _l(get_transl_field('tsl_tasks', 'prioritat',_l('tasks_list_priority')))
];
