...
<div class="modal-body">
    <div class="row">
        <div class="col-md-8 task-single-col-left">
         ...
         <?php echo 'Aufaben Eintrag'; ?>
            ...
            <div class="tasks-comments-2 inline-block full-width simple-editor"<?php if (count($task->comments) == 0) {
                ...
                <button type="button" class="btn btn-info mtop10 pull-right hide" id="addTaskCommentBtn-2"
                        autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>"
        ...
        <div class="col-md-4 task-single-col-right">
            ...
            <div class="clearfix"></div>-->
            <h4 class="task-info-heading font-normal font-medium-xs">
                <i class="fa fa-user-o" aria-hidden="true"></i> <?php echo _l('task_single_assignees'); ?>
            </h4>
