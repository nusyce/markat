    ...
    <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php echo render_input('fullname', get_transl_field('tsl_mieter', 'fullname','Vollst�ndiger Name'), $fullname); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php echo render_input('strabe_m', get_transl_field('tsl_mieter', 'strabe_m','Stra�e'), $value); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php echo render_select('flugel', $data, array('value', 'value'),  get_transl_field('tsl_mieter', 'flugel','Fl�gel'),$value); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="col-md-6">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <?php echo render_date_input('k_baubeginn', 'Keller Ber�umung', get_transl_field('tsl_mieter', 'k_baubeginn','k_baubeginn'),$value); ?>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <?php echo render_input('strabe_p', get_transl_field('tsl_mieter', 'strabe_m', 'Stra�e'), $value); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php echo render_input('fulger_p', get_transl_field('tsl_mieter', 'flugel', 'Fl�gel'), $value); ?>
            </div>
        </div>
