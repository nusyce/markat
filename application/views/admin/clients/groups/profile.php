...
<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table dt-table">
                                ...
                                <tbody>
                                <?php
                                foreach ($ansprechpartners as $k => $ansprechpartner) { ?>
                                    <tr>
                                        <td>
                                            <?= $k + 1; ?>
                                        </td>
                                        <td>
                                            <a href="#">
                                                <?php echo $ansprechpartner['vorname']; ?>
                                            </a>
                                        </td>
                                        <td>
                                            <?php echo $ansprechpartner['nachname']; ?>
                                        </td>
                                        <td>
                                            <?php echo $ansprechpartner['position']; ?>
                                        </td>
                                        <td>
                                            <a href="#"
    ...
    <div class="modal fade" id="new_ansprechpartner" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open(admin_url('clients/ansprechpartner/' . $client->userid)); ?>
                    <?= form_hidden('ansprechpartner_id', '0'); ?>
    ...
    /*                        $selected = array();
                            ...
                            echo render_select('customer_admins[]', $contacts, array('id', array('firstname', 'lastname')), '', $selected, array('multiple' => true), array(), '', '', false); */ ?>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal"><?php /*echo _l('close'); */ ?></button>
