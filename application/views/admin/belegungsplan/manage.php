            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div id="belegungsplan" class="panel-body ">
                        <div class="row">
                            <div class="col-md-2">
                                <button id="switchbtn" class="btn btn-success list"><?php echo (et_transl_field('tsl_belegungsplan', 'visualisierung', 'Visualisierung')); ?></button>
                            </div>
                            <div class="col-md-4">
...
-->
    ...
    <script>
        ...
        $(function () {
            ...
            $("#belegt_v").on('change', function (e) {
                loadGantChart();
            });
            $("#strabe").on('change', function (e) {
                loadGantChart();
            });
            $("#hausnummer").on('change', function (e) {
                loadGantChart();
            });
            $("#etage").on('change', function (e) {
                loadGantChart();
            });
            $("#flugel").on('change', function (e) {
                loadGantChart();
            });
            $("#mobiliert").on('change', function (e) {
                loadGantChart();
            });
            $("#schlaplatze").on('change', function (e) {
                loadGantChart();
            });
