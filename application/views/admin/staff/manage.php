                    ...
                    <div class="panel-body">
                        <div class="clearfix"></div>
                            ...
                            <a href="#" class="bulk-actions-btn table-btn delete-all hide" id="sqdsqd"
                               data-table=".table-staff"><?php echo _l('Alle löschen'); ?></a>
                        <?php
                        $table_data = array(
...
<script>
    $(function () {
        ...
        initDataTable('.table-staff', window.location.href, [0], [0], ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(1, 'desc'))); ?>);
