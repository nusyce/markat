...
/**
 * Prepare general wohnungen pdf
 * @param object $wohnungen Wohnungen as object with all necessary fields
 * @param string $tag tag for bulk pdf exporter
 * @return mixed object
 */

function wohnungen_pdf($wohnungen, $tag = '')
{
    return app_pdf('wohnungen', LIBSPATH . 'pdf/Wohnungen_pdf', $wohnungen, $tag);
}
