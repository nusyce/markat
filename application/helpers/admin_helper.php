...
function percentVal($active, $total)
{
    if ($total == 0) {
        return [0, 0];
    }
    ...
    return array($percent, 100 - $percent);
}

function de_date($date)
{
...
function c_menu()
{
    ...
    $segment = !empty($first_segments) ? $first_segments : $segment;
    return $segment;
}
