...
class Tasks_model extends App_Model
{
    ...
    public function copy($data, $overwrites = [])
    {
        ...
        if ($insert_id) {
            ...
            if (isset($data['copy_task_comments']) && $data['copy_task_comments'] == 'true') {
                $this->copy_task_comments($data['copy_from'], $insert_id);
            }
     ...
     * @return mixed
     */
    public function duplicate($data, $clientRequest = false)
    {
        $ticket_to_task = false;
